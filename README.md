...
Python has a [zip function](https://www.w3schools.com/python/ref_func_zip.asp)  that takes two lists and produces a list of combined tuples. Actually I think this goodie comes from Haskell,  and Haskell copied it from Lisp. The interesting question is: why isn't there an equivalent function in the C++ standard library? To find out I made my own library that does this functionality.
